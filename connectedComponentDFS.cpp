...
/*Suppose a graph has two connected components. There is a graph but it has two component 
but there is no edge connection between those two component as per the definition of 
connected component.
So here we push the vertex of the another component and apply dfs on that.And in this way
we can also know the number of connected component.
*/
#include<iostream>
#include<map>
#include<list>
